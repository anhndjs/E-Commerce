...
import com.molla.admin.exportcsv.CategoryCsvExpter;
...
public class CategoryController {
    ...
    public String listByPage(@PathVariable(name = "pageNum") int pageNum,
        ...
        List<Category> listCatagories = service.listByPage(pageInfo,pageNum,sortDir, keyword);
    ...
    public String deleteCategory(@PathVariable(name = "id") Integer id, Model model, RedirectAttributes redirectAttributes) {
        ...
        try {
            ...
            redirectAttributes.addFlashAttribute("message", "The category ID" + id + "has been delete successfuly");
    ...
    public  void exportToCSV(HttpServletResponse response) throws IOException {
        List<Category> listCategories = service.listCategoriesUsedInForm();
        CategoryCsvExpter expter = new CategoryCsvExpter();
        expter.export(listCategories, response);
    }
}
